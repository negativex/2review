              ...
              >
                ...
                <div className="h-28 xl:h-32 2xl:h-56 pt-12 2xl:pt-24">
                  ...
                  <div
                    className={`${getBackgroundColor(
                      data.results[index % data.results.length].adm_score
                    )} absolute bottom-0 right-1 xl:right-2 2xl:h-28 2xl:w-28 xl:h-16 xl:w-16 lg:h-12 lg:w-12 w-8 h-8 rounded-2xl drop-shadow-rv md:mb-6 lg:mb-2 2xl:mb-3`}
                  >
